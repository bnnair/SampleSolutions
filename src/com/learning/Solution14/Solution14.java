...
class Result {
	...
	public static List<Integer> addMeetings(List<Integer> firstDay, List<Integer> lastDay) {
		System.out.println("Current Thread-:" + Thread.currentThread());

    	List<Integer> meetings = new ArrayList<Integer>();
...
//		}
    ...
    public static CompletableFuture<List<Integer>> getCompetableFutureResult(List<Integer> firstDay, List<Integer> lastDay) {
	       return CompletableFuture.supplyAsync(()->addMeetings(firstDay, lastDay));
	    }
...
//    	CompletableFuture<List<Integer>> contents = new CompletableFuture<List<Integer>>();
//
//		contents = getCompetableFutureResult(firstDay, lastDay);
//		
//		try {
//			countList = contents.get();
//			System.out.println("allContentsFutures.get() :"+ countList);
//			countList.removeIf(e->e.intValue()==0);
//			System.out.println("allContentsFutures.get() :"+ countList);
