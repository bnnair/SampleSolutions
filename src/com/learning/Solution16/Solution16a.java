...
class Result1 {
	...
	public static int getLeftResult(int day, List<Integer> stockData, int stockPrice) {
		int leftResult=-1;
		int[] i = {0};
		...
		if(!left.isEmpty()) {
			...
			leftResult = leftResultList.isEmpty()?-1:(leftResultList.get(leftResultList.size()-1)+1);
	...
	public static int getRightResult(int day, List<Integer> stockData, int stockPrice) {
		int rightResult = -1;
		int[] i = {0};
